...
public class TestServlet extends HttpServlet {
  ...
  /* INIT PARAMETER NAME CONSTANTS */
    ...
    protected static final String ATTR_TARGET_URI =
            TestServlet.class.getSimpleName() + ".targetUri";
    protected static final String ATTR_TARGET_HOST =
            TestServlet.class.getSimpleName() + ".targetHost";
  ...
  /* MISC */
    ...
    protected String rewriteUrlFromRequest(HttpServletRequest servletRequest) {
        ...
        System.out.println("request path: "+ servletRequest.getPathInfo());
        ...
        System.out.println("request path rewrote: "+ uri);
        return uri.toString();
    }
    ...
    protected String rewriteUrlFromResponse(HttpServletRequest servletRequest, String theUrl) {
        ...
        if (theUrl.startsWith(targetUri)) {
            ...
            System.out.println("response path: "+ servletRequest.getPathInfo());
        ...
        System.out.println("repsonse path result: "+ theUrl);
